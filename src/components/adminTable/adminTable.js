...
import {ADMIN_USER_EDITOR} from "../../utils/consts";
...
function AdminTable({table_type = '', table_col_names = {}}) {
    ...
    const redirectToEditor = (item) => {
        navigate(`${ADMIN_USER_EDITOR}/${item.id}`)
        // console.log(item)
    }
    ...
    return (
        <div className={'table-container'}>
            <table className={`admin-table ${table_type} rounded-corners`}>
                {/*<thead>*/}
                <tbody>
