...
function OrderCalculationEditPage(props) {
    const {id} = useParams()
    ...
    const redirectToEditor = (orderId) => {
                ...
                <div className={'page-header'}>
                    <div className={'page-title-container flex-sb-row'}>
                        ...
                        <div className={'col-buttons-container'}>
                            <svg onClick={() => redirectToEditor(id)} width="20" height="19"
                                 viewBox="0 0 20 19"
                                 fill="none"
...
export default OrderCalculationEditPage;